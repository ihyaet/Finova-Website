      ...
      <div className="w-full max-w-[1600px] mx-auto grid lg:grid-cols-2 gap-16 lg:gap-32 items-start">
        ...
        <Reveal className="hidden lg:flex flex-col gap-10 lg:pt-[120px]">
          <div className="flex flex-col gap-5">
            <h3 className="font-pixel text-[--text-primary] leading-tight">
              Build Something<br />
              <span className="text-primary-500">Extraordinary</span>
            </h3>
            <p className="font-sans text-xl text-[--text-secondary]">
              Join thousands of teams using Finova to power their financial infrastructure.
            </p>
          </div>
        ...
        <Reveal delay={120} className="flex flex-col gap-6 w-full pt-16 md:pt-20 lg:pt-[120px]">
          ...
          <div className="flex items-center justify-between gap-4">
            <h4 className="font-pixel text-[--text-primary]">Sign Up</h4>
            <p className="font-sans text-m whitespace-nowrap">
              <span className="text-white/50">Already on Finova? </span>
              <Link
                href="/sign-in"
          ...
          <div className="flex flex-col gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-[44px] rounded-full bg-white/10 border border-transparent focus:border-primary-500 pl-11 pr-11 font-sans text-l text-white placeholder:text-white/30 outline-none transition-colors"
              />
              <button
                type="button"
            ...
            <p className="font-sans text-s text-[--text-muted] pl-4">
          ...
          <p className="font-sans text-s text-[--text-muted] text-center">
            ...
            <Link href="#" className="underline hover:text-[--text-primary] transition-colors">Terms of Service</Link>
            {' '}and{' '}
